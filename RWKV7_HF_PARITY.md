...
| Native W4 speed policy | Use Marlin/TorchAO/custom packed kernels as appropriate and select by measured card/shape policy | Accuracy/balanced/speed policy implemented; Ada 1.5B B8 decode/E2E green, four small prefill red cells remain |
...
| Ada fixed-shape and quant policy | Pass the HF-defined Qwen3.5/Albatross and W8/W4 matrices independently on 4080 and 4090 | Partial 4080 1.5B B8 six-cell snapshot; remaining batches/models and all 4090 cells missing |
