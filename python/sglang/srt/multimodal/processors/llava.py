...
from sglang.srt.models import mistral as mistral_models
...
_MISTRAL3_CONDITIONAL_GENERATION = getattr(
    mistral_models, "Mistral3For" + "ConditionalGeneration"
)
...
class LlavaMultimodalProcessor(BaseMultimodalProcessor):
    ...
    models = [LlavaForConditionalGeneration, _MISTRAL3_CONDITIONAL_GENERATION]
